          ...
          <Col className={cx('col-3')}>
            <Row className={cx('media-player-info-container')}>
              ...
              <Col className={cx('col-8', 'media-track-info-column')}>
                <span className={cx('media-track-info-name')}>In The End</span>
                <span className={cx('media-track-info-album')}>Hybrid Theory</span>
              </Col>
            </Row>
          </Col>
          <Col className={cx('col-6')}>
            <Row className={cx('media-player-controls-container')}>
              <Col className={cx('media-player-controls-column')}>
                ...
                <div className={cx('media-player-control', 'media-player-control-lg')}>
            ...
            <Row className={cx('media-player-progress-container')}>
              <Col className={cx('col-1', 'p-0', 'media-player-progress-counter-column', 'start')}>2:34</Col>
              <Col className={cx('col-10', 'media-player-progress-bar-column')}>
                <MediaProgressBarComponent value={50}/>
              </Col>
              <Col className={cx('col-1', 'p-0', 'media-player-progress-counter-column', 'end')}>4:50</Col>
            </Row>
          </Col>
          <Col className={cx('col-3')}>
